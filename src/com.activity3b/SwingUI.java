...
public class SwingUI extends JFrame implements Observer {
   ...
   private static Font labelFont =
      new Font(Font.SERIF, Font.PLAIN, 48) ;
   ...
   //     */
      ...
      this.setKelvinJLabel(station.showKelvin());
      this.setCelsiusJLabel(station.showCelsius());
      this.setFahrenheitJLabel(station.showFahrenheit());
      this.setInchesJLabel(station.showInches());
      this.setMillibarsJLabel(station.showMillibars());
   }
   ...
   public void setKelvinJLabel(double temperature) {
      kelvinField.setText(String.format("%7.2f", temperature)) ;
   }
   ...
   public void setCelsiusJLabel(double temperature) {
      celsiusField.setText(String.format("%7.2f", temperature)) ;
   }
   
   public void setFahrenheitJLabel(double temperature){
      fahrenheitField.setText(String.format("%7.2f", temperature));
   }
    
   public void setInchesJLabel(double pressure){
      inchesField.setText(String.format("%7.2f", pressure));
   }
   ...
   public static void main(String[] args) {
      ...
      KelvinTempSensorAdapter kObj = new KelvinTempSensorAdapter(kts);
      Barometer bObj = new Barometer();
      WeatherStation ws = new WeatherStation(bObj, kObj);
